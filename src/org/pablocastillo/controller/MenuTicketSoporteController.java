...
import org.pablocastillo.model.TicketSoporte;
...
public class MenuTicketSoporteController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
       ...
       cargarCmbEstatus();
       cargarCmbFactura();
       cmbClientes.setItems(listarCliente());
    }
    ...
    public void cargarDatos(){
        ...
        colEstatus.setCellValueFactory(new PropertyValueFactory<TicketSoporte, String>("estatuss"));
    ...
    public ObservableList<TicketSoporte> listarTickets() {
        ...
        try{
            ...
            while(resultSet.next()) {
                ...
                tickets.add(new TicketSoporte(ticketId, descripcionTicket, estatus, cliente, facturaId));    
            }
